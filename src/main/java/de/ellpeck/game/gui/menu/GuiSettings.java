...
public class GuiSettings extends Gui{
    ...
    public void initGui(Game game){
        ...
        this.components.add(new ComponentToggleButton(this, 1, this.guiLeft, this.guiTop+20, this.sizeX, 16, game.settings.hardwareCursor, "button.hardware_cursor", game.assetManager.localize("info.hardware_cursor")));
