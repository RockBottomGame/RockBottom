...
public class TileSignRenderer extends DefaultTileRenderer<TileSign>{
    ...
    @Override
    public void renderOnMouseOver(IGameInstance game, IAssetManager manager, IGraphics g, IWorld world, TileSign tile, TileState state, int x, int y, TileLayer layer, float mouseX, float mouseY){
