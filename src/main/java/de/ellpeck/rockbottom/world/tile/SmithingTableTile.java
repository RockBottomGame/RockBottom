...
public class SmithingTableTile extends MultiTile {
	...
	public boolean onInteractWith(IWorld world, int x, int y, TileLayer layer, double mouseX, double mouseY, AbstractPlayerEntity player) {
		...
		return tile != null && player.openGuiContainer(new SmithingTableGui(player, tile), new SmithingTableContainer(player, tile));
	}
	...
	public TileEntity provideTileEntity(IWorld world, int x, int y, TileLayer layer) {
		return this.isMainPos(x, y, world.getState(layer, x, y)) ? new SmithingTableTileEntity(world, x, y, layer) : null;
	}
