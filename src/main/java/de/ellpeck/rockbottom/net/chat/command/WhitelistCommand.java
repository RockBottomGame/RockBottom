            ...
            if ("add".equals(args[0])) {
                if (args.length > 1) {
                    ...
                    if (id != null) {
                        ...
                        return new TextChatComponent(FormattingCode.GREEN + "Added player " + id + " to the whitelist!");
                    } else {
                ...
                if (args.length > 1) {
                    ...
                    if (id != null) {
                        ...
                        net.saveServerSettings();
                        return new TextChatComponent(FormattingCode.GREEN + "Removed player " + id + " from the whitelist!");
                    } else {
                        return new TextChatComponent(FormattingCode.RED + "Couldn't parse player id!");
                    }
                } else {
