        ...
        if (sender instanceof AbstractPlayerEntity) {
            ...
            if (args.length > 0) {
                try {
                    ...
                    return new TextChatComponent(FormattingCode.RED + "'" + args[0] + "' isn't a valid entity name!");
                }
            } else {
            ...
            if (entityFactory != null) {
                try {
                    ...
                    return new TextChatComponent(FormattingCode.RED + "The entity '" + args[0] + "' cannot be spawned!");
                }
            } else {
                return new TextChatComponent(FormattingCode.RED + "An entity with the name '" + args[0] + "' doesn't exist!");
            }
        } else {
