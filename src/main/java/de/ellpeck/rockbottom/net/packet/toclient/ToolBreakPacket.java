...
public final class ToolBreakPacket implements IPacket {

    public static final ResourceName NAME = ResourceName.intern("tool_break");

    private UUID playerId;
    private ItemInstance instance;

    public ToolBreakPacket(UUID playerId, ItemInstance instance) {
        this.playerId = playerId;
        this.instance = instance;
    }

    public ToolBreakPacket() {
    }
