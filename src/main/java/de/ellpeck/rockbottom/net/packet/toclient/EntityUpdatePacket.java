...
public class EntityUpdatePacket implements IPacket {
    ...
    public static final ResourceName NAME = ResourceName.intern("entity_update");
    ...
    public EntityUpdatePacket(UUID uniqueId, double x, double y, double motionX, double motionY, Direction facing, boolean isFlying) {
