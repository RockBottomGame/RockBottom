...
public final class ContentRegistry{
    ...
    public static final Tile TILE_COPPER_ORE = new TileCopperOre().setHardness(16F).addEffectiveTool(ToolType.PICKAXE, 10).register();
    public static final Tile TILE_SMELTER = new TileSmelter().setHardness(20F).addEffectiveTool(ToolType.PICKAXE, 10).register();
    public static final Tile TILE_SEPARATOR = new TileSeparator().setHardness(20F).addEffectiveTool(ToolType.PICKAXE, 10).register();
    ...
    public static final Item ITEM_ROCK_PICK = new ItemTool("pick_rock").addToolType(ToolType.PICKAXE, 10).register();
