...
public final class ContentRegistry {
    ...
    public static void init() {
        ...
        Registries.ENTITY_REGISTRY.register(EntityItem.ID, EntityItem::new);
        Registries.ENTITY_REGISTRY.register(EntityFalling.ID, EntityFalling::new);
        Registries.ENTITY_REGISTRY.register(EntityFirework.ID, EntityFirework::new);
        Registries.ENTITY_REGISTRY.register(EntitySlime.ID, EntitySlime::new);
        Registries.ENTITY_REGISTRY.register(EntityBoomerang.ID, EntityBoomerang::new);
        Registries.ENTITY_REGISTRY.register(EntityFire.ID, EntityFire::new);

        Registries.WORLD_GENERATORS.register(WorldGenBiomes.ID, WorldGenBiomes::new);
        Registries.WORLD_GENERATORS.register(WorldGenHeights.ID, WorldGenHeights::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("grass"), WorldGenGrass::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("trees"), WorldGenTrees::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("flowers"), WorldGenFlowers::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("pebbles"), WorldGenPebbles::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("coal"), WorldGenCoal::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("start_hut"), WorldGenStartHut::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("copper"), WorldGenCopper::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("tin"), WorldGenTin::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("caves"), WorldGenCaves::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("cave_mushrooms"), WorldGenCaveMushrooms::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("stardrops"), WorldGenStardrops::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("lakes"), WorldGenLakes::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("corn"), WorldGenCorn::new);
        Registries.WORLD_GENERATORS.register(ResourceName.intern("cotton"), WorldGenCotton::new);
