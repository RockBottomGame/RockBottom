...
public class GuiConstructionTable extends GuiContainer {
    ...
    public void init(IGameInstance game) {
        ...
        this.menu = new ComponentMenu(this, -4, 1, 6, PAGE_HEIGHT - 2, 2, 4, -1, 1, new BoundingBox(0, 0, MENU_WIDTH, PAGE_HEIGHT).add(this.x, this.y), ResourceName.intern("gui.construction_table.scroll_bar"), 1);
