...
public class PlayerEditorGui extends Gui {
    ...
    public PlayerEditorGui(Gui parent) {
    ...
    public void init(IGameInstance game) {
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getEyeColor(), (design::setEyeColor)));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getEyebrowsColor(), design::setEyebrowsColor));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getHairColor(), design::setHairColor));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getShirtColor(), design::setShirtColor));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getSleevesColor(), design::setSleevesColor));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getPantsColor(), design::setPantsColor));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getFootwearColor(), design::setFootwearColor));
        y += 14;
        ...
        this.components.add(new ColorPickerComponent(this, colorX, y, design.getBeardColor(), design::setBeardColor));
        ...
        this.components.add(new de.ellpeck.rockbottom.api.gui.component.ColorPickerComponent(this, colorX - 98, 0, 12, 12, design.getFavoriteColor(), ((color, aBoolean) -> design.setFavoriteColor(color)), true));

        this.components.add(new ToggleButtonComponent(this, x - 98, 14, 80, 12, design.isFemale(), () -> {
        ...
        this.components.add(new ButtonComponent(this, x - 98, this.height - 34, 80, 14, () -> {
        ...
        this.components.add(new ButtonComponent(this, x, this.height - 34, 80, 14, () -> {
            this.components.add(new ConfirmationPopupComponent(this, x + 40, this.height - 38 + 7, aBoolean -> {
                if (aBoolean) {
                    try {
    ...
    private static class Slider extends SliderComponent {
