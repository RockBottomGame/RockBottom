...
public class ContentPacksGui extends Gui {
    ...
    public ContentPacksGui(Gui parent) {
    ...
    public void init(IGameInstance game) {
        ...
        this.leftMenu = new MenuComponent(this, halfWidth / 2 - 63, 0, this.height - 42, 1, 4, new BoundingBox(0, 0, 128, this.height - 42).add(this.x + halfWidth / 2 - 63, this.y));
        this.components.add(this.leftMenu);

        this.rightMenu = new MenuComponent(this, halfWidth + halfWidth / 2 - 63, 0, this.height - 42, 1, 4, new BoundingBox(0, 0, 128, this.height - 42).add(this.x + halfWidth + halfWidth / 2 - 63, this.y));
        ...
        this.components.add(new ButtonComponent(this, this.width / 2 - 81, this.height - 16, 80, 16, () -> {
            this.components.add(new ConfirmationPopupComponent(this, this.width / 2 - 41, this.height - 8, aBoolean -> {
                if (aBoolean) {
    ...
    private void organize() {
        ...
        for (ContentPack pack : disabledPacks) {
            MenuItemComponent comp = new MenuItemComponent(120, 26);

            comp.add(0, 0, new TextComponent(this, 0, 0, 102, 8, 0.35F, false, pack.getName()));
            comp.add(0, 8, new TextComponent(this, 0, 0, 102, 16, 0.225F, false, FormattingCode.LIGHT_GRAY + pack.getDescription()));

            comp.add(104, 0, new ButtonComponent(this, 0, 0, 16, 24, () -> {
        ...
        for (int i = 0; i < enabledPacks.size(); i++) {
            ...
            MenuItemComponent comp = new MenuItemComponent(120, 26);
            if (!pack.isDefault()) {
                comp.add(0, 0, new ButtonComponent(this, 0, 0, 16, 24, () -> {
                ...
                comp.add(104, 0, new ButtonComponent(this, 0, 0, 16, 11, () -> {
                ...
                comp.add(104, 13, new ButtonComponent(this, 0, 0, 16, 11, () -> {
                    settings.setEnabledPriority(pack.getId(), prio - 1);
                    this.packsChanged = true;
                    this.organize();
                    return true;
            ...
            comp.add(18, 0, new TextComponent(this, 0, 0, 84, 16, 0.35F, false, pack.getName()));
            comp.add(18, 16, new TextComponent(this, 0, 0, 84, 8, 0.3F, false, FormattingCode.LIGHT_GRAY + "Priority: " + prio));
