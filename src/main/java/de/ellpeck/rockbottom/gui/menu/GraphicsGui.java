...
public class GraphicsGui extends Gui {
    ...
    public void init(IGameInstance game) {
        ...
        this.components.add(new ToggleButtonComponent(this, 0, 0, 150, 16, settings.hardwareCursor, () -> {
        ...
        this.components.add(new ToggleButtonComponent(this, 0, 20, 150, 16, settings.cursorInfos, () -> {
            settings.cursorInfos = !settings.cursorInfos;
            return true;
        }, "button.cursor_infos", assetManager.localize(ResourceName.intern("info.cursor_infos"))));
        this.components.add(new SliderComponent(this, 0, 40, 150, 16, (int) (settings.textSpeed * 10F), 1, 100, ((integer, aBoolean) -> settings.textSpeed = (float) integer / 10F), assetManager.localize(ResourceName.intern("button.text_speed"))));

        this.components.add(new SliderComponent(this, 154, 0, 150, 16, (int) (settings.renderScale * 100F), 50, 150, (integer, aBoolean) -> {
        ...
        this.components.add(new SliderComponent(this, 154, 20, 150, 16, (int) (settings.guiScale * 100F), 50, 100, (integer, aBoolean) -> {
            if (aBoolean) {
        ...
        this.components.add(new ToggleButtonComponent(this, 154, 40, 150, 16, !settings.fullscreen, () -> {
            settings.fullscreen = !settings.fullscreen;
            settings.save();
            game.setFullscreen(settings.fullscreen);
            return true;
        }, "button.fullscreen"));
        this.components.add(new ToggleButtonComponent(this, 154, 60, 150, 16, !settings.smoothLighting, () -> {
