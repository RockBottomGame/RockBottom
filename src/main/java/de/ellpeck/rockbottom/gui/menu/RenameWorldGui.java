...
public class RenameWorldGui extends Gui {
    ...
    public RenameWorldGui(Gui parent, File worldFile) {
        super(parent);
    ...
    public void init(IGameInstance game) {
        ...
        InputFieldComponent field = new InputFieldComponent(this, this.width / 2 - 80, this.height / 2 - 40, 160, 16, true, false, true, 128, false, strg -> this.name = CreateWorldGui.makeNameSafe(game, strg));
        ...
        this.name = CreateWorldGui.makeNameSafe(game, "");
    }
