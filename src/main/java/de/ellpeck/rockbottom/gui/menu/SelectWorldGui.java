...
public class SelectWorldGui extends Gui {
    ...
    public SelectWorldGui(Gui parent) {
        super(parent);
    }
    ...
    public void init(IGameInstance game) {
        ...
        MenuComponent menu = new MenuComponent(this, menuX, 5, 138, 1, 5, box);
        this.components.add(menu);

        this.components.add(new ButtonComponent(this, this.width / 2 - 82, this.height - 30, 80, 16, () -> {
            game.getGuiManager().openGui(new CreateWorldGui(this));
            return true;
        ...
        if (validWorlds.isEmpty()) {
            game.getGuiManager().openGui(new CreateWorldGui(this.parent));
            return;
        }
        ...
        for (File file : validWorlds) {
            MenuItemComponent component = new MenuItemComponent(186 + 14, 26);
