...
public class GuiPlayerEditor extends Gui{
    ...
    public void init(IGameInstance game){
        ...
        this.components.add(new Slider(this, x, y, design.getBase(), IPlayerDesign.BASE.size()-1, design:: setBase, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.base"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getEyeColor(), (design:: setEyeColor)));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getEyebrows(), IPlayerDesign.EYEBROWS.size()-1, design:: setEyebrows, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.eyebrows"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getEyebrowsColor(), design:: setEyebrowsColor));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getMouth(), IPlayerDesign.MOUTH.size()-1, design:: setMouth, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.mouth"))));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getHair(), IPlayerDesign.HAIR.size()-1, design:: setHair, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.hair"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getHairColor(), design:: setHairColor));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getShirt(), IPlayerDesign.SHIRT.size()-1, design:: setShirt, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.shirt"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getShirtColor(), design:: setShirtColor));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getSleeves(), IPlayerDesign.SLEEVES.size()-1, design:: setSleeves, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.sleeves"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getSleevesColor(), design:: setSleevesColor));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getPants(), IPlayerDesign.PANTS.size()-1, design:: setPants, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.pants"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getPantsColor(), design:: setPantsColor));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getFootwear(), IPlayerDesign.FOOTWEAR.size()-1, design:: setFootwear, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.footwear"))));
        this.components.add(new ColorPicker(this, colorX, y, design.getFootwearColor(), design:: setFootwearColor));
        y += 14;
        this.components.add(new Slider(this, x, y, design.getAccessory(), IPlayerDesign.ACCESSORIES.size()-1, design:: setAccessory, assetManager.localize(RockBottomAPI.createInternalRes("button.player_design.accessory"))));
        y += 14;
