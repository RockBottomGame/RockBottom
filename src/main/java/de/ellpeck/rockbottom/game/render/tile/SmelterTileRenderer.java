...
public class SmelterTileRenderer extends MultiTileRenderer<TileSmelter>{
    ...
    @Override
    public void render(IGameInstance game, AssetManager manager, Graphics g, IWorld world, TileSmelter tile, int x, int y, float renderX, float renderY, Color filter){
