...
public class ItemTileRenderer implements IItemRenderer<ItemTile>{
    ...
    @Override
    public void render(IGameInstance game, AssetManager manager, Graphics g, ItemTile item, ItemInstance instance, float x, float y, float scale, Color filter){
    ...
    @Override
    public void renderOnMouseCursor(IGameInstance game, AssetManager manager, Graphics g, ItemTile item, ItemInstance instance, float x, float y, float scale, Color filter){
