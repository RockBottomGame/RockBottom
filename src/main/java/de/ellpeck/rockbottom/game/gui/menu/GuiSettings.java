...
public class GuiSettings extends Gui{
    ...
    public void initGui(RockBottom game){
        ...
        this.components.add(new ComponentSlider(this, 3, this.guiLeft, this.guiTop+55, 150, 16, game.settings.autosaveIntervalSeconds, 30, 1800, new ComponentSlider.ICallback(){
            @Override
